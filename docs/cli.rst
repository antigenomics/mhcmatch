...
.. important::
   ...
   **Pass ``--peptides FILE``, never loop the shell.** The expensive part of most commands is setup
   ...
   binder calibrator ~45 s. One process over a list is the difference between seconds *per peptide*
   and thousands *per second*.
...
.. toctree::
   ...
   Reproducing the published analyses <cli/reproducing>
