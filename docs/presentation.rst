...
**What this page is for.** Two of the nine terms fitted by ``mhc1.*.neoantigen`` are presentation,
and they are not the same quantity measured twice. This page says what each one asks, why both
are needed, and which call produces which.
