...
.. note::
   ...
   itself is not only a measurement: :func:`mhcmatch.complement.burial` is the ``C_phys`` term of
   the shipped aggregate (:doc:`neoantigen`).
...
.. list-table::
   ...
   * - —
     ...
     - —
   * - 1
     - **Rose burial propensity over the TCR face** (selected as a sum; shipped as the
       per-residue mean --- see below)
     - 20.0
     - 4201.4
     - −7.3
     - **admitted**
